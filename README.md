...
![image showing RStudio's completion suggestions](http://jmclawson.com/topickit/rstudio-autocomplete.png "RStudio's suggested completions are useful for discovering available views.")
